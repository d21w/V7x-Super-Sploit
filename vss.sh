...
help(){
  sound "a"
  printf "Commands: \n"
  printf "$yellow          vset       : $white تعيين عنوان المهاجم \n"
  printf "$yellow          build      : $white بناء حمولة vss (عكس برنامج التعاون الفني إلى عنوان المهاجم) \n"
  printf "$yellow          clean      : $white إزالة الفيروسات من النظام (فيروس VSS)\n"
  printf "$yellow          exploit    : $white استغلال الحمولة والحصول على الوصول عبر الغلاف العكسي \n"
  printf "$yellow          target     : $white حدد نظام التشغيل الهدف \n"
  printf "$yellow          cls        : $white إدخال الحمولة في برنامج shell script $ green (Shell Trojan) \n"
  printf "$yellow          injsh      : $white  \n"
  printf "$yellow          injpy      : $white إدخال الحمولة في برنامج Python script $ green (Python Trojan) \n"
  printf "$yellow          zsession   : $white ابدأ Z-Session لتحميل الملفات وتنزيلها\n"
  printf "$yellow          full_guide : $white اقرأ دليل الأداة\n"
  printf "$yellow          mode       : $white ضبط الوضع (قبل نشر الحمولة)\n"
  printf "$yellow          log        : $white مدير السجل\n"
  printf "$yellow          convert    : $white تدوير ملف أخضر $ (Cipher Text Rotation)\n"
  printf "$yellow          info       : $white الحصول على معلومات حول الأمر\n"
  printf "$yellow          show       : $white إظهار خيار أو كل الخيارات\n"
  printf "$yellow          update     : $white قم بتثبيت أحدث إصدار من VSS\n"    
  printf "$yellow          trojan     : $white احفظ الملف على هيئة حصان طروادة في دليل أحصنة طروادة\n"
  printf "$yellow          payload    : $white احفظ ملفًا كملف حمولة في دليل الحمولاتry\n"
  printf "$yellow          banner     : $white إظهار البانر\n"
  printf "$yellow          exit       : $white خروج\n"
  printf "                                \n"
}
